...
function Cover(props){
    ...
    const [hid, setHid] = useState({zIndex: "2", visibility: "visible", position: "absolute", height: "100vh", width: "100vw", backgroundColor: "white", textAlign: "center", paddingTop: "120px", transform: "translate(-100%,0)"})
    const [show, setShow] = useState({zIndex: "2", visibility: "visible", position: "absolute", height: "100vh", width: "100vw", backgroundColor: "white", textAlign: "center", paddingTop: "120px", transform: "translate(0,0)"})
