...
const initialstate = {
  ...
  items: [{key: 0, name: "Burger with double cheese", image: burger1, type: "burgers", price: 10.3, removableadds: ['cheese', 'cucumber', 'onions'],
        ...
        {key: 1, name: "Spicy burger",image: burger2, type: "burgers", price: 5.3, removableadds: [], options: []},
        {key: 2, name: "Coke", image: tinofcoke, type: "drinks", price: 1.3, removableadds: [], options: []},
        {key: 3, name: "Burger with double cheese", type: "burgers", price: 10.3, removableadds: [], options: []},
        {key: 4, name: "Burger with double cheese", type: "burgers", price: 10.3, removableadds: [], options: []},
        {key: 5, name: "Water 500ml bottle ", image: waterbottle, type: "drinks", price: 2.49, removableadds: [], options: []},
        {key: 6, name: "French Fries with ketchup", image: frenchfries, type: "adds", price: 8.5, removableadds: [], options: []}], 
